...
void main() {
  ...
  "result": 20.25153
    ...
    expect(oneLinerJsonResponse, equals('{"success":true,"query":{"from":"USD","to":"MXN","amount":1},"info":{"timestamp":1629952383,"rate":20.25153},"date":"2021-08-26","result":20.25153}'));
  });

  test('Should be able to get currency symbol from currency code', (){
    var format = NumberFormat.simpleCurrency(name: 'EUR');
  ...
  test('Should be able to parse symbols response', (){
    var s = '''{
  "success": true,
  "symbols": {
